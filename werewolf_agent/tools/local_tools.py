# -*- coding: utf-8 -*-
"""
功能描述：本地 LangGraph 工具分派与游戏状态查询 facade，不走 MCP。
作者：Mike
创建日期：2025-01-15
修改日期：2026-07-08
使用示例：内部模块，无对外接口
...
from werewolf_agent.tools.local_tool_memory import (
    # 兼容旧模块私有 helper 导入路径，实际实现已迁入 local_tool_memory。
    get_default_memory_store as _get_default_memory_store,  # noqa: F401
    query_cognition_matrix as _query_cognition_matrix,
