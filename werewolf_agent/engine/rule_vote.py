        ...
        if cfg["second_tie_policy"] == "no_exile_then_night":
            ...
            if (
                ...
                if anti_stall_tie_break_fn is not None:
                    return anti_stall_tie_break_fn(state, top, rng_seed, votes)
                return anti_stall_tie_break(state, top, rng_seed, votes)
