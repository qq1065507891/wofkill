"""Compatibility matrix for uploaded or built-in rulesets.

This module intentionally reflects current RuleEngine capabilities only.
Templates may describe future roles, but unsupported capabilities remain
display-only until the engine implements and tests them.
"""
