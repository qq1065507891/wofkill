...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("p03声称p05是狼人", [("p03", "p05说p06是狼人")], 1),
        ("p03声称p05不是狼人", [("p03", "p05说p06不是狼人")], 1),
        ("p03声称p05是狼人", [("p03", "p05是狼人")], 0),
        ("p03声称p05不是狼人", [("p03", "p05不是狼人")], 0),
        ("p05声称自己是预言家", [("p05", "不能说我是预言家")], 1),
        ("p05声称自己不是预言家", [("p05", "不能说我是预言家")], 0),
        ("p05声称自己是预言家", [("p05", "不应说我是预言家")], 1),
        ...
        ("p04知道狼刀信息", [("p04", "我知道狼刀信息")], 0),
        ("p04不知道狼刀信息", [("p04", "我知道狼刀信息")], 1),
        ("p04不知道狼刀信息", [("p04", "我不知道狼刀信息")], 0),
        ("p04知道狼刀信息", [("p04", "我不知道狼刀信息")], 1),
        ("p04不知道狼刀信息", [("p04", "我并不知道狼刀信息")], 0),
