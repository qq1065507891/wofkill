...
- 白痴被白天放逐后可以翻牌自证身份。
- 翻牌后的白痴视为存活，但失去投票权。
- 翻牌后的白痴仍可发言，仍属于神边，狼人需要再次击杀才能使其真正出局。
- 翻牌后的白痴不能成为警徽移交对象。
- 翻牌后的白痴状态应显式记录为 `alive + revealed_idiot + vote_disabled + badge_ineligible + exile_immune`；仍参与存活玩家发言顺序，但不再成为放逐目标，狼人需要再次夜间击杀才能使其真正出局，真正死亡后才计入神边出局。
...
- 屠神：预言家、女巫、猎人、白痴全部出局。白痴翻牌但仍存活时，不视为神边出局。
...
- 夜晚行动流程
- 死亡原因、死亡时机和技能触发矩阵
- 女巫全程不能自救、猎人毒死不能开枪、白痴翻牌存活但失去投票权、遗言权等规则
- 平安夜、平安日、平票和自爆分支
- 警徽竞选、警徽流、传徽和撕徽规则
- 白天发言占位流程
- 投票与放逐
...
- 猎人被女巫毒死不能开枪。
- 白痴被毒死不触发翻牌。
- 白痴翻牌后仍存活、可发言、失去投票权、不能接警徽、不能再次被放逐；被狼人再次夜间击杀后才计入神边出局。
